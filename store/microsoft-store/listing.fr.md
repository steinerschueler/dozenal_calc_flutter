# Microsoft Store Listing — Dozenal Calc (fr)

App name (global): **Dozenal Calc**
Tagline (ouverture optionnelle) : Une « calculatrice duodécimale » avec une notation inédite des nombres.

## Description (à coller dans Partner Center → Store listings → French (France) → Description)
