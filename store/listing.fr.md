# Play Store Listing — Dozenal Calc (fr)

Locale-spezifischer Upload-Inhalt für die Play Console (Sprache:
Français / `fr-FR`). Für die universellen Felder (Package Name,
...
(Max. 4000 Zeichen — verwendet ≈ 3650.)

```html
Une « calculatrice duodécimale » — une calculatrice scientifique qui compte non pas en dix, mais en douze. Avec ses propres symboles pour les chiffres.

<b>Ce que la base 12 sait faire et que la base 10 ne sait pas</b>
...
• Arithmétique de base + parenthèses + signes
• Puissance, racine carrée, racine n-ième
• Logarithme dans n'importe quelle base
• Addition parallèle (a⊕b = ab/(a+b)) — utile pour les circuits de résistances
• Trigonométrie (sin, cos, tan, cot) et leurs réciproques
...
<b>À qui s'adresse-t-elle ?</b>

Aux enseignant·es qui souhaitent montrer comment un autre système numérique changerait le quotidien du calcul fractionnaire. Aux élèves qui souhaitent voir leurs mathématiques sous un angle inhabituel.
