...
const Map<String, TheoryImage> kTheoryImages = {
  'world/0': TheoryImage('assets/theory/world_0.jpg',
  ...
  'world/1': TheoryImage('assets/theory/world_1.jpg',
  ...
  'world/2': TheoryImage('assets/theory/world_2.jpg',
  ...
  'world/8': TheoryImage('assets/theory/world_8.jpg',
  ...
  'world/9': TheoryImage('assets/theory/world_9.jpg',
  ...
  'world/10': TheoryImage('assets/theory/world_10.jpg',
  ...
  'math/3': TheoryImage('assets/theory/math_3.jpg',
  ...
  'society/0': TheoryImage('assets/theory/society_0.jpg',
  ...
  'society/2': TheoryImage('assets/theory/society_2.jpg',
  ...
  'unit/area': TheoryImage('assets/theory/unit_area.jpg',
  ...
  'unit/space': TheoryImage('assets/theory/unit_space.jpg',
  ...
  'unit/weight': TheoryImage('assets/theory/unit_weight.jpg',
  ...
  'unit/price': TheoryImage('assets/theory/unit_price.jpg',
  ...
  'unit/temp': TheoryImage('assets/theory/unit_temp.png',
...
const Map<String, AppRef> kTheoryAppRefs = {
  'society/4': AppRef('assets/theory/dozecal_icon.jpg',
      name: 'Dozecal',
      maker: 'Johan Kovacs',
      genre: 'iOS · Utilities',
      url: 'https://apps.apple.com/app/id1521160089'),
  'society/5': AppRef('assets/theory/rapoport_icon.png',
